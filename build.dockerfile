# This dockerfile uses extends image https://hub.docker.com/sinlov-go/go-sticker
# VERSION 1
# Author: sinlov
...
ARG GO_ENV_PACKAGE_NAME=github.com/sinlov-go/go-sticker
ARG GO_ENV_ROOT_BUILD_BIN_NAME=go-sticker
ARG GO_ENV_ROOT_BUILD_BIN_PATH=build/${GO_ENV_ROOT_BUILD_BIN_NAME}
ARG GO_ENV_ROOT_BUILD_ENTRANCE=cmd/go-sticker/main.go
...
ENTRYPOINT [ "/app/go-sticker" ]
# CMD ["/app/go-sticker", "--help"]